...
export default function MeetupsPage() {
	...
	const { data, isLoading, isFetching } = api.meetings.getAll.useQuery({
		take: pageSize,
		skip: page * pageSize,
	});
			...
			{isLoading ? (
				...
				<>
					...
					<div className="mt-6 flex items-center justify-between gap-3">
						<button
							className="rounded-lg border border-border px-3 py-1.5 text-muted-foreground text-sm disabled:opacity-50"
